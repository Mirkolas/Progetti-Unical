    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http, AuthenticationProvider authenticationProvider) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/biglietto/utente/**").hasRole("USER")
                        .requestMatchers("/api/ordine/utente/**").hasRole("USER")
                        .requestMatchers("/api/**").hasRole("USER")
                        .requestMatchers("/api/utente/cambiaPassword/**").hasRole("USER")
                        .requestMatchers("/api/utente/aggiorna/**").hasRole("USER")
