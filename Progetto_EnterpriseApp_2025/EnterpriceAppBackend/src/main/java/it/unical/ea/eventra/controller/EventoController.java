...
public class EventoController {
    ...
    public ResponseEntity<EventoDTO> updateEvento(@PathVariable Long id, @RequestBody EventoEditDTO eventoEditDTO) {
        EventoDTO updatedEvento = eventoService.update(id, eventoEditDTO);
