...
class SessionManager(context: Context) {
    ...
    fun saveUserSession(token: String, refreshToken: String, userId: Long, userRole: String = "USER") {
        ...
        Log.d("SessionManager", "Session saved for user: $userId with role: $userRole")
    }
    ...
    fun saveUserRole(role: String) {
        ...
        Log.d("SessionManager", "User role saved: $role")
    }

    fun getUserRole(): String {
        val role = sharedPreferences.getString("user_role", "USER")
        Log.d("SessionManager", "Retrieved user role: $role")
        return role ?: "USER"
    }
