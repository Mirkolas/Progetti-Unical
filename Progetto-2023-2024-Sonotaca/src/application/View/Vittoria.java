...
public class Vittoria {
    ...
    private Function[] createItems(ArrayList<Object> func){
        ...
        items[1] = new Function(func.getLast(), new Point((ImpostazioniDim.Lunghezza_Finestra-MenuPrincipale.getStringWidth((String) func.get(1),GamePanel.Stile2))/2-25,545));
        return items;
    }
